...
async function msgHandler (client, message) {
    try {
        ...
        const isOwner = sender.id === '6282260756087@c.us'
            ...
            case '#STICKER':
              case 'stimker':
                if (isMedia) {
                    ...
                    client.reply(from, 'Selesai, Follow https://instagram.com/ahdalvi_ Thanks:)', message.id)
...
`
        ...
        case 'ytmp3':
            if (args.length >= 1){
                ...
                try {
                    client.reply(from, 'Wait,terkadang lama..', message.id)
      ...
      case 'ig':
            if (args.length >= 1) {
                ...
                try {
                    ...
                    if (resp.mediatype == 'photo') {
                        ...
                        client.sendFileFromUrl(from, resp.descriptionc, `igeh${ext}`, 'Instagram Downloader • Bot Haram', message.id)
                } catch {
        ...
        case 'quotemaker':
            ...
            if (arg.length >= 3) {
                ...
                client.reply(from, 'Tutor: \n!quotemaker |teks|watermark|theme\n\nEx :\n!quotemaker |alviganteng|ahdalvi_|random', message.id)
            }
            break
          case 'link':
            if(!isBotGroupAdmins) return client.reply(from, 'Perintah ini hanya bisa di gunakan ketika bot menjadi admin', message.id)
...
jika ada masalah,hubungi wa.me/6282260756087
